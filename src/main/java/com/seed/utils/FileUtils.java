...
import com.seed.enums.FileType;
...
public class FileUtils {
	...
	public static String GetFullFileName(String sourcefile) {
		String rtn = sourcefile;
	...
	public static String moveFile(String sourcefile, String destpath) throws Exception {
		CreateFolder(destpath);
		
		File source = new File(sourcefile);
		
		source.renameTo(new File(destpath + source.getName()));
		
		return destpath + source.getName();
	}
	
	public static boolean isTmpFile(String sourcefile) {
		return sourcefile.contains(sourcefile);
	}
	...
	public static byte[] BarCode(String msg){
      ...
      try {
      	BitmapCanvasProvider bitmap = new BitmapCanvasProvider(
            bout, MimeTypes.MIME_JPEG, resolution,
	...
	public static void main(String args[]) { 
		System.out.println(GetFileExt("attach/20180910/027f23b53bb24413bebb6a9bca982ec1.jpg"));
		
		String fieldcode = "auditint.tododesc";
		
		System.out.println(fieldcode.substring(0, fieldcode.indexOf(".")));
		System.out.println(fieldcode.substring(fieldcode.indexOf(".") + 1));
	}
}
