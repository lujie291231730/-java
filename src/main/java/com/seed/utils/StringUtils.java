...
public class StringUtils {
  ...
  public static String GetFmtDouble(double in) {
  	return GetFmtDouble(in, "0.00");
  }
  
  public static String GetFmtDouble(double in, String fmt) {
  ...
  public static String RandomCode(int len) {
  	...
  	String rtn = "";
  	for (int i = 0; i < len; i++)
  		rtn += String.valueOf(rd.nextInt(10));
