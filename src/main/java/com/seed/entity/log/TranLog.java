...
public class TranLog implements BaseBean {
	...
	public String[] OnProperties() {
		return new String[] { "序号:transerial", "交易流水:tranid", "操作人员:tranuser",
				"操作员姓名:username", "机构:trandept", "机构名称:deptname", "交易代码:trancode",
				"菜单名称:mname", "交易动作:tranaction", "交易动作名称:tranactionname", "说明:trandesc", "交易时间:trandate" };
	}
	...
	public void ActionToTran(int value) {
		this.tranaction = TranAction.parse(value).getTranaction();
	}
}
