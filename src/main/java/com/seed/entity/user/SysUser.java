...
public class SysUser implements BaseBean {
	...
	public String[] OnProperties() {
		return new String[] { "操作员编号:userid", "操作员姓名:username", "所属机构:deptid",
				"机构名称:deptname", "所属公司:coid", "公司名称:coname", "创建日期:crtdate",
				"操作员岗位:userpost", "操作员岗位名称:userpostname", "操作员级别:userlevel",
				"操作员级别名称:userlevelname", "操作员职务:usertitle", "操作员职务名称:usertitlename",
				"操作员状态:userstatus", "操作员状态名称:userstatusname", "登陆密码:userpassword",
				"业务流水号:userserial", "当前工作日期:workdate", "上一有效工作日:preworkdate",
				"数据权限范围:authbound", "是否系统管理员:isadmin", "是否锁定:islock", "是否首次登录:isfirst",
				"输错密码次数:errorpassword", "操作员电话:usertele", "操作员电子邮件:useremail",
				"密码最后修改日期:modifypassword", "备用:remark" };
	}
