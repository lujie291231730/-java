...
public class SysCompany implements BaseBean {
	...
	public String[] OnProperties() {
		return new String[] { "公司编码:coid", "公司名称:coname", "公司简称:coshort",
				"打印抬头:coheader", "排序序号:sortorder", "公司类型:cotype", "公司类型名称:cotypename",
				"公司状态:costatus", "公司状态名称:costatusname", "备用:remark" };
	}
