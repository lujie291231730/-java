...
public class SysDept implements BaseBean {
	...
	public String[] OnProperties() {
		return new String[] { "机构编号:deptid", "机构名称:deptname", "机构简称:deptshort",
				"所属公司:coid", "公司名称:coname", "上级机构编号:deptpid", "城市代码:citycode",
				"机构级别:deptlevel", "部门级别名称:deptlevelname", "机构类别:depttype",
				"部门类型名称:depttypename", "机构层次深度:deptdepth", "排序序号:sortorder",
				"机构状态:deptstatus", "部门状态名称:deptstatusname", "备用:remark" };
	}
